  ...
  return (
    <div className="header">
      <div className="header-left-content">
        ...
        <div className="header-left-h1">
          <div className="h1-responsive">
            ...
            {!lang ? (
              <Slide left>
                <p>
                  Je suis <span className="header-R">R</span>aphaël.
                </p>
              </Slide>
            ) : (
              <Slide left big>
                <p>
                  {" "}
                  I'm <span className="header-R">R</span>aphael.
                </p>
              </Slide>
            )}
        ...
        {!lang ? (
          <Slide bottom big>
            <a href="/contact" id="header-button" type="button">
              {" "}
              CONTACTEZ MOI !
            </a>
          </Slide>
      ...
      <div id="content-img" style={styles.root}>
        ...
        <Zoom right>
          <Tilt className="parallax-effect-img" scale={1} duration={5}>
